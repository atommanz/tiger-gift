...
<<<<<<< HEAD
  ...
  // Debug: แสดง formData เมื่อโหลดหน้า
  useEffect(() => {
    ...
    <div className="relative h-screen overflow-hidden bg-white">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-3 py-2 bg-transparent pointer-events-none">
        ...
        <div className={`flex items-center gap-1.5 px-3 py-1.5 bg-white rounded-full shadow-md pointer-events-auto ${
          ...
          <Star className={`w-4 h-4 ${count === 0 ? 'text-gray-400 fill-gray-400' : 'text-yellow-400 fill-yellow-400'}`} />
          <span className="text-xs font-medium">
            {count === 0 ? 'ไม่พบสินค้า' : `แนะนำให้คุณ ${count} ชิ้น`}
          </span>
        </div>
          ...
          <div className="h-screen w-full snap-start flex flex-col items-center justify-center px-6">
            ...
            >
              ...
              <motion.div
                ...
                className="mb-6"
              >
                <Star className="w-20 h-20 text-gray-300 fill-gray-300 mx-auto" />
              </motion.div>
              ...
              >
                ลองเปลี่ยนคำตอบในแบบสอบถามใหม่อีกครั้ง<br />
                หรือลดจำนวนตัวเลือกที่เลือกไว้
              </motion.p>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => router.push('/')}
                className="px-8 py-3 bg-black text-white rounded-full font-bold shadow-lg hover:shadow-xl transition-shadow"
              >
                กลับไปเริ่มต้นใหม่
              </motion.button>
            </motion.div>
